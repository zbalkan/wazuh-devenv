...
def main(disable_builtin: bool = False, disable_custom: bool = False, disable_behavioral: bool = False, verbosity: int = 1) -> None:
    # Run preflight tests
...
if __name__ == "__main__":
    try:
        ...
        main(disable_builtin=args.enable_builtin, verbosity=args.verbosity)
